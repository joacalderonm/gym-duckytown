...
class LaneFollowSimulator:
    ...
    def _init_simulation_parameters(self, args):
        ...
        self.upper_bound = np.array([35, 255, 255])  # Valores máximos para el amarillo
...
#       # Parámetros de manejo de intersecciones
    ...
    def run(self):
        """
        Ejecuta el simulador de seguimiento de carriles.
        Realiza el seguimiento de carriles, integración de odometría y visualización de la trayectoria.
        """
        obs = self.env.reset()
        self.env.render()
        ...
        try:
            while True:
                ...
                self.env.render()
                time.sleep(self.dt)  # Esperar el tiempo de cuadro
